...
function onUpdate()
	if tinocoPaused == true then -- if paused
		...
		doTweenX('left', 'left', 1, 0.2, 'linear') -- left img slide anim
		doTweenX('right2', 'right2', 871, 0.2, 'linear') -- right img slide anim
		...
		doTweenX('left', 'left', -1300, tweentime, 'linear') -- bye bye left img
		doTweenX('right2', 'right2', 1500, tweentime, 'linear') -- adios right img
