...
function onCreate()
    ...
    if count < 15 then
        makeLuaText('songText', "".. useName.. " - ".. toughness, 400, getProperty('bgThing.x') + 180, 580) -- 30 letters is the width limit
        ...
        makeIt = true
        makeLuaText('songText', "".. useName, 200, getProperty('bgThing.x') + 180, 480) -- Too big song name
        setObjectCamera("songText", 'other');
        setTextColor('songText', '0x'..songTxtColor)
        setTextSize('songText', 40);
        addLuaText("songText");
