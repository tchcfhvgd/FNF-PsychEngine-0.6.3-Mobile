...
function onCreate()
	...
	addLuaSprite('bg')
        makeLuaSprite('left3', 'pause/left3', -1000, 220);
...
function onUpdate()
	if tinocoPaused == true then -- if paused
		...
		doTweenX('left3', 'left3', 30, 0.2, 'linear') -- left img slide anim
		doTweenX('right', 'right', 766, 0.2, 'linear') -- right img slide anim
		doTweenAlpha('left3a', 'left3', 1, 0.001, 'linear') -- left alpha
		...
		doTweenX('left3', 'left3', -1000, tweentime, 'linear') -- bye bye left img
		doTweenX('right', 'right', 1200, tweentime, 'linear') -- adios right img
		doTweenAlpha('left3a', 'left3', 0, 0.1, 'linear') -- alpha anim
