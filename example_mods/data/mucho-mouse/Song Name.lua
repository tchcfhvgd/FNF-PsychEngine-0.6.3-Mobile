...
local moveOutTime = 3 -- How long should it last
...
function onCreate()
	...
	makeLuaSprite('bgThing', 'songBG6', -550, 410)
    ...
    if makeIt == true then -- too big of a song name
        ...
        setTextFont('optionalText', "UT.ttf")
    ...
    setTextFont('beforeSongText', "UT.ttf")
