...
function onCreate()
	...
	makeLuaSprite('bgThing', 'songBG11', -550, 470)
    ...
    if count < 15 then
        makeLuaText('songText', "".. useName.. " - ".. toughness, 400, getProperty('bgThing.x') + 180, 551) -- 20 letters is the width limit
    ...
    makeLuaText('beforeSongText', "Now Playing... ", 300, getProperty('bgThing.x') + 100 - 40, 470)
    ...
    if showCredit == true then
        makeLuaText('whoDuntIt', "Made by - ".. name, 400, getProperty('bgThing.x') + 180, 635)
