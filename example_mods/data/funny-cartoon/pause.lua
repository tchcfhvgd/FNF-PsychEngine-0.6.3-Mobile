...
function onCreate()
	...
	addLuaSprite('bg')
        makeLuaSprite('left2', 'pause/left2', -1000, 20);
	scaleObject('left2', 1, 1);
        setObjectCamera('left2', 'other')
                addLuaSprite('left2',true)
        makeLuaSprite('right3', 'pause/right3', 1200, -100);
	scaleObject('right3', 0.7, 0.7);
        setObjectCamera('right3', 'other')
                addLuaSprite('right3',true)
...
function onUpdate()
	if tinocoPaused == true then -- if paused
		...
		doTweenX('left2', 'left2', -20, 0.2, 'linear') -- left img slide anim
		doTweenX('right', 'right', 766, 0.2, 'linear') -- right img slide anim
		doTweenX('right3', 'right3', 766, 0.2, 'linear') -- right img slide anim
		doTweenAlpha('left2a', 'left2', 1, 0.001, 'linear') -- left alpha
		doTweenAlpha('right3a', 'right3', 1, 0.001, 'linear') -- left alpha
		...
		doTweenX('left2', 'left2', -1000, tweentime, 'linear') -- bye bye left img
		doTweenX('right', 'right', 1200, tweentime, 'linear') -- adios right img
		doTweenX('right3', 'right3', 1200, tweentime, 'linear') -- adios right img
		doTweenAlpha('left2a', 'left2', 0, 0.1, 'linear') -- alpha anim
		doTweenAlpha('right3a', 'right3', 1, 0.001, 'linear')
...
function ILOVEBUTTONS()
	if getPropertyFromClass('flixel.FlxG', 'android.justReleased.BACK') and die == 0 then -- if pressed pause button
