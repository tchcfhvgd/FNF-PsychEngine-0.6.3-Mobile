...
function onCreate()
	...
	makeLuaSprite('bgThing', 'songBG17', -550, 410)
    ...
    if count < 15 then
        makeLuaText('songText', "".. useName.. " - ".. toughness, 400, getProperty('bgThing.x') + 180, 550) -- 20 letters is the width limit
        ...
        makeIt = true
        makeLuaText('songText', "".. useName, 400, getProperty('bgThing.x') + 180, 500) -- Too big song name
        setObjectCamera("songText", 'other');
        setTextColor('songText', '0x'..songTxtColor)
        setTextSize('songText', 40);
        addLuaText("songText");
