...
function onCustomSubstateCreate(tag)
	if tag == 'death' then
        ...
        createBox('gameoverblackbox',defaultBoyfriendX - 1500,defaultBoyfriendY - 1000,3000,3000,'000000',1,'camGame')


        makeAnimatedLuaSprite('dead', 'characters/'..Assets.character.name, defaultBoyfriendX, defaultBoyfriendY);
        ...
        addOffset('dead','idle',500,0)
        addOffset('dead','loop',500,0)
        addOffset('dead','confirm',500,0)
